...
public class Controller {
    ...
    // hashmap with id and value is array 
    private HashMap<Integer, String[]> studentMap = new HashMap<>(); // Corrected capitalization
    ...
    public String getStudentById(@PathVariable int id) { // Corrected method name
